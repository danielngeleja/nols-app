...
| `APPLE_PASSKEY_BUNDLE_IDS` | `com.nolsaf.driver,com.nolsaf.partners` |
...
| Variable | Format |
| --- | --- |
| `ANDROID_PASSKEY_APPS` | `<package>=<sha256-fp>\|<sha256-fp>;<package>=...` e.g. `com.nolsaf.driver=AA:BB:...:FF\|11:22:...:EE` |
...
3. On a staging API, set `WEB_AUTHN_RP_ID` to the staging domain and
   `WEB_AUTHN_NATIVE_ORIGINS` to the debug-keystore apk-key-hash.
