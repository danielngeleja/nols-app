...
export const CANCELLATION_POLICY_LAST_UPDATED = "12 July 2026";
    ...
    content: (
      <div className="space-y-4">
        <p>
          ...
          Users may cancel their bookings free of charge within 24 hours of making the reservation, provided the cancellation occurs at least 72 hours before the scheduled check-in time. This grace period allows Users to reconsider their booking without financial penalty, subject to the 72-hour advance notice requirement. Refunds arising from cancellations within this free cancellation period are paid in full and are exempt from the refund payment charges described in section 8.4.
        </p>
        <p>
          <strong>2.2 Partial Refunds</strong><br />
          Cancellations made after the free cancellation period, but at least 4 days (96 hours) before the scheduled check-in time, may be eligible for a 50% refund of the total amount paid, less the refund payment charges described in section 8.4. The refund will be processed to the original payment method within 5-10 business days after the cancellation is confirmed.
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <p><strong>4A.2 System-Initiated Request</strong><br />The Traveler has the right to initiate a cancellation through the Tour Package section of their NoLSAF account. Submission creates a dated cancellation case and immediate provisional eligibility calculation. For a paid booking, submission does not itself cancel the booking: the booking remains active until NoLSAF approves the request and confirms the final refund or other remedy. A booking for which no payment has been received is cancelled immediately upon the Traveler&apos;s request, with no refund due, no review required, and no charge of any kind.</p>
        ...
        <p><strong>4A.4 Advance Partial Refund</strong><br />After the 24-hour cooling-off period, a cancellation submitted at least 96 hours before tour commencement is provisionally eligible for a 50% refund of the amount paid. The final refund may be reduced only by: (a) non-refundable components that were disclosed before payment; (b) services already consumed; (c) reasonable costs of recovering committed funds; and (d) funds the operator has already and verifiably deployed to underlying service providers such as lodges, hotels, park authorities, or vehicle suppliers, limited to the portion those providers will not return. Every reduction must be supported by verifiable supplier receipts, permits, tickets, deposits, booking confirmations, or equivalent records, and each item is individually reviewed and may be rejected by NoLSAF. No reduction of any kind applies where the operator or NoLSAF caused the cancellation.</p>
        ...
        <p><strong>4A.8A Refund Payment Charges</strong><br />Approved refunds are paid to the original payment method less the following method-specific costs, which will be itemised in the refund confirmation: (a) refunds to card payments: less a 6% card processing surcharge and an administrative charge of TZS 25,000; (b) refunds to mobile money or bank accounts: less the actual transfer charges debited by NoLSAF&apos;s bankers and an administrative charge of TZS 25,000; (c) cash or manually processed payments: less any actual bank charges incurred and an administrative charge of TZS 25,000. These charges do not apply to: cancellations within the 24-hour cooling-off window under section 4A.3, which remain a true 100% refund; refunds arising from operator or NoLSAF-caused cancellations under section 4A.7; or bookings made before this charges policy took effect. The total charges will never exceed the refund amount.</p>
        <p><strong>4A.9 Alternatives, Review and Payment</strong><br />NoLSAF may offer rescheduling, a comparable replacement or future travel credit. Unreasonably refusing a safe and materially equivalent remedy may affect eligibility. Approved monetary refunds are returned to the original payment method and currency, less any applicable charges under section 4A.8A, subject to the processing timelines in section 8. Open cancellation, refund or serious issue cases place the operator&apos;s final payout on hold. Where NoLSAF has already released funds to the operator before an approved cancellation, NoLSAF recovers those funds directly from the operator; this recovery is between NoLSAF and the operator and never delays or reduces the Traveler&apos;s approved refund.</p>
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          ...
          Refund amounts will be calculated based on the cancellation policy applicable to the booking, minus any applicable cancellation fees, service charges, non-refundable components, and the refund payment charges described in section 8.4. The refund confirmation will provide a detailed breakdown of the refund calculation, including an itemised list of any charges applied.
        </p>
        <p>
        ...
        <p>
          <strong>8.4 Refund Payment Charges</strong><br />
          Approved refunds are paid to the original payment method less the following method-specific costs, which will be itemised in the refund confirmation: (a) refunds to card payments: less a 6% card processing surcharge and an administrative charge of TZS 25,000; (b) refunds to mobile money or bank accounts: less the actual transfer charges debited by NoLSAF&apos;s bankers and an administrative charge of TZS 25,000; (c) cash or manually processed payments: less any actual bank charges incurred and an administrative charge of TZS 25,000. These charges do not apply to: refunds arising from cancellations within the free cancellation period under section 2.1; refunds arising from property owner or NoLSAF-caused cancellations under section 9; or bookings made before this charges policy took effect. The total charges will never exceed the refund amount. For tour packages, the equivalent charges are described in section 4A.8A.
        </p>
      </div>
    ),
  },
